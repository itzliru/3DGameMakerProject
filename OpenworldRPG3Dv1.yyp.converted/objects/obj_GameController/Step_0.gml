...
// Screenshot hotkey (F12) — calls global.debug_take_screenshot()
if (keyboard_check_pressed(vk_f12) && variable_global_exists("debug_take_screenshot")) {
    var out = global.debug_take_screenshot();
    // optionally show additional message if function returned a filename
